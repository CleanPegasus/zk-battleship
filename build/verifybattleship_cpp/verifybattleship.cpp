...
void QuinSelector_3_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void QuinSelector_3_run(uint ctx_index,Circom_CalcWit* ctx);
void Edwards2Montgomery_4_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Edwards2Montgomery_4_run(uint ctx_index,Circom_CalcWit* ctx);
void MultiMux3_5_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MultiMux3_5_run(uint ctx_index,Circom_CalcWit* ctx);
void MontgomeryDouble_6_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MontgomeryDouble_6_run(uint ctx_index,Circom_CalcWit* ctx);
void MontgomeryAdd_7_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MontgomeryAdd_7_run(uint ctx_index,Circom_CalcWit* ctx);
void Window4_8_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Window4_8_run(uint ctx_index,Circom_CalcWit* ctx);
void Montgomery2Edwards_9_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Montgomery2Edwards_9_run(uint ctx_index,Circom_CalcWit* ctx);
...
void VerifyBattleshipPosition_12_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void VerifyBattleshipPosition_12_run(uint ctx_index,Circom_CalcWit* ctx);
Circom_TemplateFunction _functionTable[13] = { 
Decoder_0_run,
EscalarProduct_1_run,
Multiplexer_2_run,
QuinSelector_3_run,
Edwards2Montgomery_4_run,
MultiMux3_5_run,
MontgomeryDouble_6_run,
MontgomeryAdd_7_run,
Window4_8_run,
Montgomery2Edwards_9_run,
Segment_10_run,
Pedersen_11_run,
VerifyBattleshipPosition_12_run };
...
uint get_main_input_signal_no() {return 103;}

uint get_total_signal_no() {return 3886;}

uint get_number_of_components() {return 329;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 410;}
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[0]); // line circom 23
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&signalValues[mySignalStart + 11],&lvar[2]); // line circom 24
...
Fr_sub(&expaux[3],&signalValues[mySignalStart + 11],&lvar[2]); // line circom 25
Fr_mul(&expaux[1],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 0)],&expaux[3]); // line circom 25
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_add(&expaux[0],&lvar[1],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 0)]); // line circom 26
// end load src
...
Fr_sub(&expaux[3],&signalValues[mySignalStart + 10],&circuitConstants[2]); // line circom 30
Fr_mul(&expaux[1],&signalValues[mySignalStart + 10],&expaux[3]); // line circom 30
...
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 21)];
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 1)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 11)]); // line circom 11
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[1];
// load src
Fr_add(&expaux[0],&lvar[1],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 21)]); // line circom 12
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[0]); // line circom 55
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[2];
// load src
Fr_add(&expaux[0],&lvar[2],&circuitConstants[2]); // line circom 55
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[0]); // line circom 55
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[0]); // line circom 60
while(Fr_isTrue(&expaux[0])){
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((10 * Fr_toInt(&lvar[3])) + (1 * Fr_toInt(&lvar[2]))) + 10)]);
}
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 10],&circuitConstants[2]); // line circom 67
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "decoder";
Decoder_0_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 12 ;
aux_cmp_num += 1;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "scalar_product";
EscalarProduct_1_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 31 ;
aux_cmp_num += 1;
...
// load src
// end load src
Fr_copyn(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],10);
}
// need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 10;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[3]); // line circom 40
while(Fr_isTrue(&expaux[0])){
{
...
Fr_mul(&expaux[4],&circuitConstants[12],&signalValues[mySignalStart + 2]); // line circom 137
Fr_add(&expaux[2],&expaux[3],&expaux[4]); // line circom 137
Fr_add(&expaux[1],&expaux[2],&circuitConstants[2]); // line circom 137
Fr_mul(&expaux[2],&circuitConstants[3],&signalValues[mySignalStart + 3]); // line circom 137
Fr_div(&expaux[0],&expaux[1],&expaux[2]); // line circom 137
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_mul(&expaux[3],&circuitConstants[3],&signalValues[mySignalStart + 3]); // line circom 138
...
Fr_mul(&expaux[5],&circuitConstants[12],&signalValues[mySignalStart + 2]); // line circom 138
...
Fr_sub(&expaux[1],&expaux[2],&circuitConstants[11]); // line circom 140
Fr_mul(&expaux[2],&circuitConstants[3],&signalValues[mySignalStart + 2]); // line circom 140
...
Fr_sub(&expaux[2],&expaux[3],&circuitConstants[11]); // line circom 105
...
MultiMux3_5_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 38 ;
aux_cmp_num += 1;
}
...
MontgomeryDouble_6_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 6 ;
aux_cmp_num += 1;
}
...
MontgomeryAdd_7_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 7 ;
aux_cmp_num += 1;
}
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
MontgomeryDouble_6_run(mySubcomponents[cmp_index_ref],ctx);
}
{
uint cmp_index_ref = 0;
{
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
MontgomeryAdd_7_run(mySubcomponents[cmp_index_ref],ctx);
}
{
uint cmp_index_ref = 0;
{
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
MultiMux3_5_run(mySubcomponents[cmp_index_ref],ctx);
}
{
...
Fr_mul(&expaux[2],&expaux[3],&circuitConstants[3]); // line circom 108
...
Edwards2Montgomery_4_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 4 ;
aux_cmp_num += 1;
}
...
Window4_8_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 96 ;
aux_cmp_num += 9;
}
...
Montgomery2Edwards_9_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 4 ;
aux_cmp_num += 1;
}
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Edwards2Montgomery_4_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &lvar[1];
// load src
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[13]); // line circom 130
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[2];
// load src
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Window4_8_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[3]); // line circom 154
// end load src
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 3];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[3]); // line circom 155
// end load src
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Montgomery2Edwards_9_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Segment_10_run(mySubcomponents[cmp_index_ref],ctx);
...
Fr_lt(&expaux[0],&lvar[43],&circuitConstants[15]); // line circom 208
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
...
Fr_lt(&expaux[0],&lvar[43],&circuitConstants[38]); // line circom 212
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
...
ctx->componentMemory[coffset].templateName = "VerifyBattleshipPosition";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 103;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "multiplexer";
...
uint csoffset = mySignalStart+3830;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "quinSelector";
QuinSelector_3_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 55 ;
aux_cmp_num += 3;
}
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 5],100);
}
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 100;
assert(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
}
{
uint cmp_index_ref = 0;
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
QuinSelector_3_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((10 * Fr_toInt(&lvar[2])) + (1 * Fr_toInt(&lvar[3]))) + 5)]);
}
{
PFrElement aux_dest = &lvar[3];
// load src
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 106],101);
}
// need to run sub component
...
// load src
// end load src
Fr_copyn(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0],2);
}
for (uint i = 0; i < 3; i++){
uint index_subc = ctx->componentMemory[ctx_index].subcomponents[i];
if (index_subc != 0)release_memory_component(ctx,index_subc);
...
VerifyBattleshipPosition_12_create(1,0,ctx,"main",0);
VerifyBattleshipPosition_12_run(0,ctx);
}
